  ...
  return (
    <div className="mt-5 flex justify-between">
      <div className="flex w-3/4">
        ...
        <div className="flex flex-col justify-center ">
          {isLoading ? (
            ...
            <h1 className="text-[44px] ml-10 opacity-90 leading-[50px] font-extralight font-satoshi text-zinc-300">
              {data?.name}
            </h1>
          )}
          {isLoading ? (
      ...
      <div className="w-1/4 flex justify-end">
        <p className="text-lg mt-5 font-satoshi">
          <button
            className="hover:cursor-pointer"
            onClick={() => {
              setIsAudioPlayerShown(true);
            }}
          >
            play
          </button>
