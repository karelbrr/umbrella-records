...
import RelatedBeats from "./RelatedBeats";
          ...
          <div className="space-y-6 ">
            <div
              className={`relative aspect-square overflow-hidden ${
                (isLoading && "animate-pulse") || (error && "animate-pulse")
              } bg-muted border border-border shadow-2xl`}
            >
              <Image
            ...
            {isLoading || error ? (
              ...
              <div className="space-y-3 pt-4">
                <div className="flex space-x-2">
                  ...
                  {data?.is_desc_ai && <Badge variant={"outline"} className="bg-violet-950 ">Generated by Ai</Badge>}
                </div>
